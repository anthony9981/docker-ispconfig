...
RUN apt-get -qq update && apt-get -y -qq --force-yes install hhvm
...
RUN apt-get -qq update && apt-get -y -qq libxml2 libxml2-dev libbz2-dev libcurl4-gnutls-dev libfcgi-dev libfcgi0ldbl libjpeg62-turbo-dbg libjpeg62-turbo-dev libpng12-dev libkrb5-dev libmcrypt-dev libssl-dev libfreetype6-dev libc-client2007e libc-client2007e-dev libxslt1-dev
RUN apt-get autoremove -y && apt-get clean
